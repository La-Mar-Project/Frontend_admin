                    ...
                    <div className="flex items-center gap-[12px]">
                      <div className="flex items-center gap-[10px] px-[20px] py-[9px] rounded-[10px] border border-[#BDBDBD] bg-white w-[184px]">
                        ...
                        <input 
                          ...
                          className="text-[16px] font-normal text-[#272C3C] bg-transparent outline-none flex-1" 
                  ...
                  filteredLogs.map((item, index) => (
                    <div key={item.id} className="flex items-center">
                      ...
                      <div className="flex justify-center items-center px-[20px] py-[12px] border-2 border-[#DFE7F4] bg-white w-[66px] h-[48px]">
                        <span className="text-[18px] font-normal text-[#272C3C] whitespace-nowrap text-center" style={{ fontFamily: 'Pretendard' }}>{filteredLogs.length - index}</span>
                      </div>
