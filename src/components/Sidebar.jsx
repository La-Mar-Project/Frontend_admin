...
function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 z-50 sidebar-responsive bg-[#F7F8FC]" style={{ height: '100vh', minHeight: '100vh', bottom: 0, overflowY: 'auto', display: 'flex', flexDirection: 'column' }}>
      {/* 로고 영역 */}
      <div className="h-[77px] ml-[53px] mt-[56px] w-[149px] flex-shrink-0" style={{ marginLeft: '53px', marginTop: '56px', width: '149px', height: '77px' }}>
        <div
      ...
      {/* 사이드바 메뉴 */}
      <div className="relative flex-1" style={{ minHeight: 'calc(585px * var(--scale))', marginLeft: 'calc(25px * var(--scale))', marginTop: 'calc(109px * var(--scale))', width: 'calc(187px * var(--scale))', paddingBottom: 'calc(50px * var(--scale))' }}>
        {/* 운영관리 섹션 */}
        ...
        {/* 예약관리 섹션 */}
        <div className="relative" style={{ marginTop: 'calc(67px * var(--scale))' }}>
          <p className="font-semibold leading-[28px] text-[#272c3c] text-[26px]" style={{ fontSize: 'calc(26px * var(--scale))', lineHeight: 'calc(28px * var(--scale))', marginLeft: 'calc(41px * var(--scale))' }}>
            예약관리
          </p>
          {/* 예약관리 아이콘 */}
          <svg className="absolute" style={{ left: 'calc(0px * var(--scale))', top: 'calc(0px * var(--scale))', width: 'calc(24px * var(--scale))', height: 'calc(24px * var(--scale))' }} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
